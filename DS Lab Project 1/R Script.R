...
raw_lines <- readLines("UncleanDataset.csv", warn = FALSE, encoding = "latin1")
...
#    - Some rows are pipe-delimited, others comma-delimited
...
write.csv(df_clean, "CleanedDataset.csv", row.names = FALSE, na = "")
